    ...
    <Layout title='Phillip England - Software Developer'>
        <>
            ...
            <div className="flex items-center justify-center p-12 flex-col gap-12">
                ...
                <div>
                    <button className="bg-primary w-fit px-4 py-2 rounded-sm text-white text-lg hover:bg-white hover:text-primary border border-primary cursor-pointer animate-bounce">Hire Me</button>
            ...
            <nav className="flex flex-col items-center justify-center p-8 text-lg gap-12">
                <ul className="flex flex-row gap-8">
                    <li>
                        <a href="/about" className="cursor-pointer border rounded-lg p-2 border-gray-400 hover:bg-black hover:text-white">About</a>
                    </li>
                    <li>
                        <a href="/projects" className="cursor-pointer border rounded-lg p-2 border-gray-400 hover:bg-black hover:text-white">Projects</a>
                    </li>
                    <li>
                        <a href="/blog" className="cursor-pointer border rounded-lg p-2 border-gray-400 hover:bg-black hover:text-white">Blog</a>
                    </li>
                </ul>
                <ul className="flex flex-row gap-8">
                    <li>
                        <a href="https://github.com/phillip-england" className="cursor-pointer">
