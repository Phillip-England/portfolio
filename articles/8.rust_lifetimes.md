...
[here](https://github.com/Phillip-England/sandbox-rust-lifetimes).

The conversation I had with ChatGPT about the topic is
[here](https://chatgpt.com/share/6762cc56-3184-8005-87ec-841eaf4826ba). I do a
...
[Tristram Oaten](https://github.com/0atman/noboilerplate) on his YouTube
channel, [No Boilerplate](https://www.youtube.com/c/NoBoilerplate).

He said, "..lifetimes let us know **when** our data is."

So, let's checkout
[The Book](https://doc.rust-lang.org/rust-by-example/scope/lifetime.html) and
...
Despite not feeling confident about lifetimes, I _am_ pretty familiar with the
...
[Elision Rules](https://doc.rust-lang.org/nomicon/lifetime-elision.html).
