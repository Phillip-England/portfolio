        ...
        <header className="p-4 flex gap-8 justify-between top-0 sticky bg-white z-50 select-none flex-row md:flex-col">
            ...
            { props.hasIcon ?
                <div className="flex items-center md:hidden">
                    <svg id='icon-bars' className="w-8 h-8 flex md:hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" strokeLinecap="round" strokeWidth="2" d="M5 7h14M5 12h14M5 17h14"/>
                    </svg>
                    <svg id='icon-x' className="w-8 h-8 hidden md:hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
