...
export const ProjectCard = (props: {
  ...
  return (
    <a href={props.href} className="rounded-lg border border-gray-100 shadow-md w-fit p-4 flex flex-col gap-4 hover:shadow-xl hover:shadow-secondary cursor-pointer">
