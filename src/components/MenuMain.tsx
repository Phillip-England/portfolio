...
export const MenuMain = (props: {
  ...
  return (
    <nav
      id="menu-main"
      className="bg-white p-4 text-lg max-w-[70%] h-full fixed left-0 top-0 z-30 hidden w-full"
    >
      <ul className="flex flex-col gap-4 w-full">
        <div className="h-[90px]"></div>
        <div className="flex flex-row gap gap-8 items-center">
          <li>
            <a
          ...
          <li>
            <a href="https://www.facebook.com/phillip.england.559842/?viewas=100000686899395">
            <svg
              className="w-10 h-10 text-gray-800"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
